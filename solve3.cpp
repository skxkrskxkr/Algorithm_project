...
int main()
{
	std::ifstream in_f("input.txt"); // 분석할 input파일을 읽어오는 코드
	std::string test_string; // 코드를 받아올 String 변수
	std::string pattern_string = "TTT";  // 찾을 pattern 문자열
	...
	std::cout << "test string 길이 :" << test_string.length() << std::endl;
	std::cout << "find pattern :" << pattern_string << std::endl;
